...
<div class="row">
  ...
  <div class="card-body">
    ...
    <form id="seniorPersonalForm" action="<?= site_url('profile/senior/personal/save') ?>" method="post" novalidate>
      <?= csrf_field() ?>
      <div class="row g-3">
        <div class="col-md-6">
...
document.addEventListener('DOMContentLoaded', function(){
  const form = document.getElementById('seniorPersonalForm');
  ...
  form.addEventListener('submit', async function(e){
    ...
    try {
      ...
      setTimeout(()=> {
        window.location.href = data.redirect || '<?= site_url('profile/senior/employment') ?>';
      }, 900);
