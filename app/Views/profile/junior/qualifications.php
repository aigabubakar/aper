...
<?= $this->section('title') ?>Junior — Qualifications<?= $this->endSection() ?>
...
<div class="row">
  ...
  <div class="card-body">
   <h4 class="card-title">Qualifications</h4>
    ...
    <form id="qualForm" action="<?= site_url('profile/junior/qualifications/save') ?>" method="post" novalidate>
      <?= csrf_field() ?>
      ...
      <div class="d-flex justify-content-between">
        <a href="<?= site_url('profile/junior/employment') ?>" class="btn btn-outline-secondary">Back</a>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  form.addEventListener('submit', async function(e){
    ...
    try {
      ...
      else window.location.href = '<?= site_url('profile/junior/experience') ?>';
