...
<div class="card mx-auto" style="max-width:1100px;">
  <div class="card-body">
    ...
    <form id="employmentForm" action="<?= site_url('profile/junior/employment/save') ?>" method="post" novalidate>
      <?= csrf_field() ?>
      ...
      <div class="d-flex justify-content-between">
        <a href="<?= site_url('profile/junior/personal') ?>" class="btn btn-outline-secondary">Back</a>
        <div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  form.addEventListener('submit', async function(e){
    ...
    try {
      ...
      else window.location.href = '<?= site_url('profile/junior/qualifications') ?>';
